<?php
	switch($_REQUEST["acao"]){
		case "cadastrar":
			$sql = "INSERT INTO consultor (nome_consultor,cpf_consultor, rg_consultor, endereco_consultor, telefone_consultor, email_consultor, usuario_consultor, senha_consultor) VALUES ('".$_REQUEST["nome_consultor"]."','".$_REQUEST["cpf_consultor"]."','".$_REQUEST["rg_consultor"]."','".$_REQUEST["endereco_consultor"]."','".$_REQUEST["telefone_consultor"]."','".$_REQUEST["email_consultor"]."','".$_REQUEST["usuario_consultor"]."','".$_REQUEST["senha_consultor"]."')";
		...
		case "editar":
			$sql = "UPDATE consultor SET 
						...
						usuario_consultor='".$_REQUEST["usuario_consultor"]."'
				    WHERE 
