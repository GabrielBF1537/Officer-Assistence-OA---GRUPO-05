<?php
	switch($_REQUEST["acao"]){
		case "cadastrar":
			$sql = "INSERT INTO consulta (agenda_cliente_id_cliente, agenda_id_agenda, hora_consulta, dia_consulta, mes_consulta) VALUES (".$_REQUEST["agenda_cliente_id_cliente"].", '".$_REQUEST["agenda_id_agenda"]."', '".$_REQUEST["hora_consulta"]."', '".$_REQUEST["dia_consulta"]."', '".$_REQUEST["mes_consulta"]."')";
